// RUN: mlir-opt %s --sparsifier="enable-runtime-library=true" | mlir-runner -e main -entry-point-result=void -shared-libs=../../+_repo_rules+llvm-project/mlir/libmlir_c_runner_utils.so,../../+_repo_rules+llvm-project/mlir/libmlir_runner_utils.so | FileCheck %s
